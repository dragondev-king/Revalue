...
export const initialState = {
  ...
  inputs: {
    ...
    minPrice: extractInputValueFromLocalStorage('minPrice', null),
    maxPrice: extractInputValueFromLocalStorage('maxPrice', null),
    minArea: extractInputValueFromLocalStorage('minArea', null),
    maxArea: extractInputValueFromLocalStorage('maxArea', null),
